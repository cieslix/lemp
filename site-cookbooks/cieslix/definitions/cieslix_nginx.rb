# copy from nginx cookbook with small changes
define :cieslix_nginx, :index => [], :servers => [], :root => nil, :static => [], :fastcgi_index => [], :fastcgi_param => [], :error_page => [], :fastcgi_intercept_errors => false do
    ...
    template params[:name] do
        ...
        variables({
            ...
            :fastcgi_index => params[:fastcgi_index],
            :index => params[:index],
